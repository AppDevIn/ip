...
/**
 * Main JavaFX application class for Duke chatbot.
 * Creates and manages the GUI components including the chat interface,
...
public class Main extends Application {
     ...
     * Initializes the chat interface, loads user images, and configures
     * the window layout and styling.
     *
