...
public class FindCommandTest {
    ...
    @Test
    public void execute_findWithMatchingTasks_displaysCorrectResults() throws DukeException {
    ...
    @Test
    public void execute_findWithNoMatches_displaysNoResults() throws DukeException {
        TaskList tasks = new TaskList();
        tasks.add(new Todo("buy groceries"));
    ...
    @Test
    public void execute_caseInsensitiveSearch_findsMatches() throws DukeException {
        TaskList tasks = new TaskList();
        tasks.add(new Todo("Read Book"));
